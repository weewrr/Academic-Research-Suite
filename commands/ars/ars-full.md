...
Mode reference: `scripts/academic-research-skills/MODE_REGISTRY.md` § academic-pipeline.
Skill entry: `scripts/academic-research-skills/academic-pipeline/SKILL.md`.
