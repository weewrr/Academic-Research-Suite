...
Mode reference: `scripts/academic-research-skills/MODE_REGISTRY.md` § academic-paper-reviewer.
Skill entry: `scripts/academic-research-skills/academic-paper-reviewer/SKILL.md`.
